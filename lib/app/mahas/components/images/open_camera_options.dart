...
typedef PathImageDocumentSelectedCallback = void Function(String path);

class OpenCameraOptions {
  /// If you wanna just return the path (string), you can use this method
  static Future<String?> getImage(BuildContext context, PhotoType photoType,
      {String? source,
  ...
  double _megaByte(String docPath) {
    var bytes = File(docPath).readAsBytesSync().lengthInBytes;
